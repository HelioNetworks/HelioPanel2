...
?>
   ...
   <a href="resources.php?go=guide" class="button orange">HelioHost Guide &rarr;</a><br /><br />
	...
	<a href="http://heliohost.grd.net.pl/monitor/" class="button orange">Server Monitor &rarr;</a><br /><br />
	<a href="scripts.php?go=dns" class="button orange">DNS Checker &rarr;</a><br /><br />
	<a href="http://twitter.com/heliohost" class="button orange">Twitter &rarr;</a><br /><br />
	<a href="http://www.helionet.org/index/index.php?showtopic=7178" class="button orange">Common Support Questions &rarr;</a><br /><br />
...
?>
   <a href="resources.php" class="button orange">&larr; Back</a><br /><br />
					<div class="post">
						<h2 class="title"><a href="http://wiki.helionet.org/Terms">Terms of Service</a></h2>
						<div class="entry">
...
?>
   <a href="resources.php" class="button orange">&larr; Back</a><br /><br />
					<div class="post">
						<h2 class="title"><a href="http://www.cl58services.co.cc/heliohost/v2/guide.html">Holistic HelioHost Guide</a></h2>
						<div class="entry">
	<div id="page-wrap">
	     <div id="guide">
    		...
    		<div class="list-wrap">
                ...
                <p>HelioHost support is done exclusively through the the following tools:</p>
        		    ...
        		    <li><a href="http://www.helionet.org/index/">Support Forums @ HelioNet</a></li> 
        		    <li><a href="scripts.php">Account Scripts</a></li>
        		    <li><a href="wiki.php">Wiki</a></li>
        		    <li><a href="http://www.heliohost.org/home/support/chat">IRC Live Chat</a></li>
...
?>
   <a href="resources.php" class="button orange">&larr; Back</a><br /><br />
					<div class="post">
						<h2 class="title"><a href="http://www.cl58services.co.cc/heliohost/v2/faq.html">FAQs</a></h2>
						<div class="entry">
<div id="faqs">
				...
				<br />
				<p><strong>This FAQ addresses <u>specific</u> questions. For a more holistic guide to HelioHost, read the <a href="http://www.helionet.org/index/index.php?showtopic=7178">Commonly Asked Questions post</a> on HelioNet.</strong></p>
...
<span>I log in frequently but am still receiving inactivity emails, what gives?</span>
			<div>
		            <p>To ensure that your logins are logged, use the cPanel login form at the bottom of <a href="http://www.heliohost.org/home/">HelioHost.org</a> to login.</p>
			</div>
...
<span>How do I fix a problem with an addon domain?</span>
			<div>
		            <p>Refer to the following HelioNet post: <a href="http://www.helionet.org/index/index.php?showtopic=5553">http://www.helionet.org/index/index.php?showtopic=5553</a></p>
			</div>
...
<p>It is also possible that this was an error in our system.  If you suspect that this is the case, report the error in a new post <a href="http://www.helionet.org/index/index.php?showforum=81">here</a>.
			</div>
...
<br />If you continuously see this page, try clearing your browser cache. Also see <a href="http://www.helionet.org/index/index.php?showtopic=8604">this HelioNet post</a></p>
			</div>
...
<span>How do I delete my hosting account?</span>
			<div>
				...
				<br />
				<p>*Note: To delete your HelioNet account, post a topic in the <a href="www.helionet.org/index/index.php?showforum=4">Contact HelioNet</a> forum.</p>
			</div>
...
<span>How do I change my main domain?</span>
			<div>
				...
				<br />
				<p>*Note: As an alternative to changing your main domain, consider using parked, addon, and/or sub-domains.  See <a href="http://wiki.helionet.org/Parked,_Addon_and_Sub_Domains">this wiki article</a> for more information.
			</div>
...
<span>Can Feature XYZ be installed?</span>
			<div>
		            <ul>
				<li>If you need a system-wide feature installed, post your request on our <a href="http://www.google.com/moderator/#16/e=a5c91">Google Moderator page</a>.</li>
				<li>Stuff like phpBB and Wordpress can be installed via <a href="http://wiki.helionet.org/Softaculous">Softaculous</a>.</li>
			</ul>
			</div>
...
<span>I can't seem to install phpBB via source.</span>
			<div>
		            <p>Please see <a href="http://www.helionet.org/index/index.php?showtopic=5180&view=findpost&p=46062">this HelioNet thread</a>.</p>
			</div>
<span>Why don't my WordPress permalinks work?</span>
			<div>
		            <p>Please see <a href="http://wordpress.org/support/topic/356829#post-1462937">this thread</a> on the WordPress forums.</p>
			</div>
...
<span>Your hosting SUCKS! So do YOU!!!</span>
			<div>
		            <p>Please see <a href="http://www.helionet.org/index/index.php?showtopic=4723&view=findpost&p=46231">this</a> and <a href="http://s3.zetaboards.com/The_Aftermath/topic/304216/1/">this</a>.</p>
			</div>
<span>I still have a question about Helio<u>host</u>.</span>
			<div>
		            <p>Post in the <a href="http://www.helionet.org/index/index.php?showforum=48">Questions</a> forum and we'll try to help you the best we can..</p>
			</div>
</div>						</div>
					</div>
<?php
